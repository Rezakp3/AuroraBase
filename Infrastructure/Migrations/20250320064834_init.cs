        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpireTimeInMinute = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    PrivateKey = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PublicKey = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessKey = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Claims_Businesses_BusinessKey",
                        column: x => x.BusinessKey,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Groups_Businesses_BusinessKey",
                        column: x => x.BusinessKey,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menus_Businesses_BusinessKey",
                        column: x => x.BusinessKey,
                        principalTable: "Businesses",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Roles_Businesses_BusinessKey",
                        column: x => x.BusinessKey,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MicroServiceName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BusinessKey = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_Businesses_BusinessKey",
                        column: x => x.BusinessKey,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoginCode = table.Column<int>(type: "int", nullable: true),
                    LoginCodeTryCount = table.Column<int>(type: "int", nullable: true),
                    LoginCodeExpirationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Auth_Businesses_BusinessKey",
                        column: x => x.BusinessKey,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Media = table.Column<short>(type: "smallint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupClaims_Claims_ClaimId",
                        column: x => x.ClaimId,
                        principalTable: "Claims",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuServices_Menus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Menus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuServices_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_BusinessKey",
                table: "Groups",
                column: "BusinessKey");

            migrationBuilder.CreateIndex(
                name: "IX_Menus_BusinessKey",
                table: "Menus",
                column: "BusinessKey");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuServices_MenuId",
                table: "MenuServices",
                column: "MenuId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuServices_ServiceId",
                table: "MenuServices",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Profile_CityId",
                table: "Profile",
                column: "CityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_PhoneNo_BusinessKey",
                table: "Users",
                columns: new[] { "PhoneNo", "BusinessKey" },
                unique: true,
